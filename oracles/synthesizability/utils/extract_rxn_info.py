...
def data_from_rxn_smiles(rxn_smiles: str) -> Dict[str, Union[str, int]]:
    """
    ...
    NOTE: To avoid installing Rxn-INSIGHT into the Saturn environment, we use subprocess to run Rxn-INSIGHT.
    """
...
if __name__ == "__main__":
    ...
    rxn_info = data_from_rxn_smiles(rxn_smiles)
